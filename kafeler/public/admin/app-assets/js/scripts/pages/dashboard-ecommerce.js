...
$(window).on('load', function () {
 ...
 // Sayfa URL'si kontrol edilerek sadece /dashboard rotasında çalışmasını sağla
if (window.location.pathname === '/dashboard') {
  setTimeout(function () {
    toastr['success'](
      site_name + "'a başarılı bir şekilde giriş yaptınız.  " + site_name + "'un Fırsatlarını Keşfedin!",
      "👋 Hoşgeldin " + userName + "!",
      {
        closeButton: false,
        tapToDismiss: false,
